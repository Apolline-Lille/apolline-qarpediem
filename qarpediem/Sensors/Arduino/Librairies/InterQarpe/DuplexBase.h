...
class DuplexBase {
	...
	static const uint32_t TIMEOUT_QUERY_RECEIVED = 300;
	static const uint32_t TIMEOUT_RESPONSE_RECEIVED = 300;
...
protected:
	 ...
	 */
	void send_response_ok(void);

	/**
	 * send a "error" response without any data
	 */
	void send_response_error(void);
